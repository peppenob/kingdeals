...
const footerGroups = [
  ...
  },
  {
    title: "Servizi",
    links: [
      { label: "Amazon Prime", href: "/servizi/prime" },
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-6 text-slate-400">
              Guide, recensioni e confronti originali per aiutarti a scegliere
        ...
        <div className="mt-12 border-t border-slate-800 pt-8">
          ...
          <p className="mt-3 text-xs text-slate-500">
            Amazon e i relativi marchi appartengono ad Amazon.com, Inc. o alle
            sue affiliate. KingDeals è un progetto editoriale indipendente.
          </p>
